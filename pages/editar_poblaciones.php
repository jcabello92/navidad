...
<html lang="en">
    ...
    <script>
      function lanzar_editor(id)
      {
        ...
        document.getElementById('edi-poblacion').submit();
      }
    </script>
    <!-- FIN JAVASCRIPT -->
            ...
            <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl" id="navbarBlur" navbar-scroll="true">
                <div class="container-fluid py-3 px-3">
                    <nav aria-label="breadcrumb">
                        <h3 class="font-weight-bolder mb-0">Editar Poblaciones</h3>
                    </nav>
                                      ...
                                      <?php
                                          ...
                                          if($poblaciones != null)
                                          {
                                            for($i = 0; $i < count($poblaciones); $i++)
                                            {
                                              ...
                                              echo '<button class="btn" style="background-color: #253C59; color: white;" type="button" onclick="lanzar_editor(' . "'" . $poblaciones[$i][0] . "'" . ')">Editar</button>'; // CONECTAR EDITOR PERSONALIZADO...
                                              echo '</a>';
                                              echo '</td>';
                                              echo "</tr>";
                                            }
