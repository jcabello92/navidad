...
<html lang="en">
    ...
    <script>
      ...
      document.getElementById('modal_v1_boton').onclick = function ()
      {
          ...
          location.href = "editar_menores.php";
      }
    ...
    <?php
      ...
      if(isset($_POST['rut'], $_POST['nombre'], $_POST['apellido'], $_POST['sexo'], $_POST['fecha_nacimiento'], $_POST['direccion'], $_POST['jdv']))
      {
        ...
        if(actualizar_menor($rut, $nombre, $apellido, $sexo, $fecha_nacimiento, $direccion, $jdv))
        {
      ...
      if(isset($_POST['rut']))
      {
        $menor = mostrar_menor($_POST['rut']);

        $rut = $menor[0][0];
        $nombre = $menor[0][1];
        $apellido = $menor[0][2];
        $sexo = $menor[0][3];
        $fecha_nacimiento = $menor[0][4];
        $direccion = $menor[0][5];
        $jdv = $menor[0][6];
      }

      function actualizar_menor($rut, $nombre, $apellido, $sexo, $fecha_nacimiento, $direccion, $jdv)
      {
        $sql = "UPDATE menores SET MEN_NOMBRE = '" . $nombre . "', MEN_APELLIDO = '" . $apellido . "', SEX_ID = " . $sexo . ", MEN_FECHA_NACIMIENTO = '" . $fecha_nacimiento . "', MEN_DIRECCION = '" . $direccion . "', JV_ID = " . $jdv . " WHERE MEN_RUT = '" . $rut . "';";
            ...
            <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl" id="navbarBlur" navbar-scroll="true">
                <div class="container-fluid py-3 px-3">
                    <nav aria-label="breadcrumb">
                        <h3 class="font-weight-bolder mb-0">Editar Menor</h3>
                    </nav>
            ...
            <div class="container-fluid">
                <div class="col-xl-4 col-lg-5 col-md-7 mx-auto">
                    <div class="card z-index-0">
                        <div class="card-body">
                            <form role="form text-left" name="edi-menor" method="post" action="editar_menor.php">
                                ...
                                <div class="mb-3">
                                    <input type="text" class="form-control" id="nombre" name="nombre" maxlength="60" required placeholder="Ingrese el nombre del menor" <?php echo "value='" . $nombre . "'";?>>
                                </div>
                                <label>APELLIDO DEL MENOR</label>
                                <div class="mb-3">
                                    <input type="text" class="form-control" id="apellido" name="apellido" maxlength="60" required placeholder="Ingrese el apellido del menor" <?php echo "value='" . $apellido . "'";?>>
                                </div>
                                ...
                                <div class="mb-3">
                                    <input type="text" class="form-control" id="direccion" name="direccion" maxlength="150" placeholder="Ingrese la dirección del menor" <?php echo "value='" . $direccion . "'";?>>
                                </div>
                                ...
                                <select class="mb-3 form-select" id="jdv" name="jdv" required>
                                    <?php
                                        ...
                                        if($jdvs != null)
                                        {
                                          for($i = 0; $i < count($jdvs); $i++)
                                          {
                                            $option = "<option value='" . $jdvs[$i][0] . "'";
                                            if($jdv != '')
                                            {
                                              if($jdv == $jdvs[$i][0])
                                              {
                                ...
                                <div class="text-center">
                                    ...
                                    <button type="button" class="btn bg-gradient-dark w-40 my-4 mb-2" style="margin-left: 2%;" id="cancelar" onclick="location.href='editar_menores.php'">Cancelar</button>
                                </div>
                            </form>
                        </div>
                    </div>
