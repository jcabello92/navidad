        ...
        <aside class="sidenav navbar navbar-vertical navbar-expand-xs my-0 fixed-start" style="z-index: 0;" id="sidenav-main">
            ...
            <div class="" id="sidenav-collapse-main">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="../pages/eliminar_poblaciones.php">
            ...
            <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl" id="navbarBlur" navbar-scroll="true">
                <div class="container-fluid py-3 px-3">
                    <nav aria-label="breadcrumb">
                        <h3 class="font-weight-bolder mb-0">Eliminar Poblaciones</h3>
                    </nav>
                    ...
                    <table class="table align-items-center mb-0">
                      <thead>
                        <tr style="background-color: #253C59; color: white;">
                          ...
                          <th class="text-center text-uppercase text-xs font-weight-bolder col-11">NOMBRE</th>
                        </tr>
                      </thead>
                      <tbody>
                        ...
                        <?php
                          ...
                          if($poblaciones != null)
                          {
                            ...
                            {
                              echo '<script>agregar_indice(' . $poblaciones[$i][0] . ');</script>';
                              ...
                              echo '<p class="text-xs font-weight-bold mx-2 mb-0">' . $poblaciones[$i][1] . '</p>';
                              echo '</td>';
                              echo "</tr>";
                            }
                          }
