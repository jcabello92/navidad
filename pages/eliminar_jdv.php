...
<html lang="en">
    ...
    <form name="filtrar" id="filtrar" method="post" action="eliminar_jdv.php">
    ...
    <body class="g-sidenav-show bg-gray-100">
        ...
        <aside class="sidenav navbar navbar-vertical navbar-expand-xs my-0 fixed-start" style="z-index: 0;" id="sidenav-main">
            ...
            <div class="" id="sidenav-collapse-main">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="../pages/eliminar_jdv.php">
        ...
        <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
            ...
            <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl" id="navbarBlur" navbar-scroll="true">
                <div class="container-fluid py-3 px-3">
                    <nav aria-label="breadcrumb">
                        <h3 class="font-weight-bolder mb-0">Eliminar Juntas de Vecinos</h3>
                    </nav>
            ...
            <div class="container-fluid">
              ...
              <form role="form text-left" name="buscar" method="post" action="eliminar_jdv.php">
                      ...
                      <nav class="navbar navbar-main navbar-expand-lg px-0 mx-2 shadow-none border-radius-xl" id="navbarBlur" navbar-scroll="true">
                        <div class="container-fluid py-0 px-0">
                            <div class="collapse navbar-collapse mt-sm-0 mt-2 me-md-0 me-sm-4">
                                <ul class="navbar-nav  justify-content-end">
                                    <li class="nav-item d-flex align-items-center">
                                        <a href="javascript:;" class="nav-link text-body font-weight-bold px-0" onclick="recargar_pagina('eliminar_jdv.php')">
                              ...
                              <tbody>
                                      ...
                                      <?php
                                          ...
                                          if($jdv != null)
                                          {
                                            ...
                                            {
                                              echo '<script>agregar_indice(' . $jdv[$i][0] . ');</script>';
