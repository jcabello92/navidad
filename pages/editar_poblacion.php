...
<html lang="en">
    ...
    <script>
      ...
      document.getElementById('modal_v1_boton').onclick = function ()
      {
          ...
          location.href = "editar_poblaciones.php";
      }
    ...
    <?php
      ...
      // SE ACTUALIZAN DATOS
      if(isset($_POST['id'], $_POST['poblacion']))
      {
        $id = $_POST['id'];
        $poblacion = $_POST['poblacion'];

        $verificar = verificar_repetido($poblacion, $id);

        // NO EXISTE EL DATO EN LA BASE DE DATOS
        if($verificar == 2)
        {
          // SE REGISTRO CORRECTAMENTE EL DATO EN LA BASE DE DATOS
          if(actualizar_poblacion($id, $poblacion))
          {
            $titulo_modal = "ACTUALIZACIÓN DE DATOS EXITOSA";
            $informacion_modal = $poblacion . " se ha actualizado correctamente en el sistema.";
          ...
          {
            $titulo_modal = "ERROR";
            $informacion_modal = "Ha ocurrido un error actualizando " . $poblacion . " en el sistema.";
      ...
      if(isset($_POST['id']))
      {
        $pobla = mostrar_poblacion($_POST['id']);

        $id = $pobla[0][0];
        $poblacion = $pobla[0][1];
      }

      function verificar_repetido($poblacion, $id)
      {
        $sql = "SELECT * FROM poblaciones WHERE POB_NOMBRE = '" . $poblacion . "' AND POB_ID != " . $id . ";";
        return comprobar_repetido($sql);
      }

      function actualizar_poblacion($id, $poblacion)
      {
        $sql = "UPDATE poblaciones SET POB_NOMBRE = '" . $poblacion . "' WHERE POB_ID = " . $id . ";";
        ...
        <aside class="sidenav navbar navbar-vertical navbar-expand-xs my-0 fixed-start" style="z-index: 0;" id="sidenav-main">
            ...
            <div class="" id="sidenav-collapse-main">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="../pages/editar_poblaciones.php">
            ...
            <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl" id="navbarBlur" navbar-scroll="true">
                <div class="container-fluid py-3 px-3">
                    <nav aria-label="breadcrumb">
                        <h3 class="font-weight-bolder mb-0">Editar Población</h3>
                    </nav>
            ...
            <div class="container-fluid">
                <div class="col-xl-4 col-lg-5 col-md-7 mx-auto">
                    <div class="card z-index-0">
                        <div class="card-body">
                            <form role="form text-left" name="edi-poblacion" method="post" action="editar_poblacion.php">
                                ...
                                <div class="mb-3">
                                    <input type="text" class="form-control" id="poblacion" name="poblacion" maxlength="60" required placeholder="Ingrese el nombre de la población" <?php echo "value='" . $poblacion . "'";?>>
                                </div>
                                <div class="text-center">
                                  <button type="submit" class="btn bg-gradient-dark w-40 my-4 mb-2" style="margin-right: 2%;" id="actualizar">Actualizar</button>
                                  <button type="button" class="btn bg-gradient-dark w-40 my-4 mb-2" style="margin-left: 2%;" id="cancelar" onclick="location.href='editar_poblaciones.php'">Cancelar</button>
                                </div>
                            </form>
                        </div>
                    </div>
